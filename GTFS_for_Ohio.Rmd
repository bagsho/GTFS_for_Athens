...
The webpage links that contain the stop and route data were provided in the beginning of the project. The route data on the links are in pdf format and the address for each stop can be accessed via the hyperlinks in the <https://ridegobus.com/stops/>. An example information for one particular stop is shown below.

![](data/ohio/akron_station_address.PNG){width="265"}

### Scraping the stop addresses

The addresses of all stops that are provided in the webpage were scraped with the codes below.

Firstly, the links for stops were created.
