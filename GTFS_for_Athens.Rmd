...
The web information was initially imported from web and then saved to a local directory. Then it is imported from that directory. The reason for this is that the web information is not stable and all of the routes are not published together all the time. So the routes were imported when all the routes were published.
